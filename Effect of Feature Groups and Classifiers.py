...
dataset = pd.read_excel(r"D:\Drug Target Interaction\Datasets\Main datasets\Experiments\All Dataset\Experiments\Enzyme Drug Target Pair Datasets\Enzyme AX.xlsx")
